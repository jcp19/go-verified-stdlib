...
BY_ERROR = {
    ...
    "postcondition":        ("3.2", "Copy the clause to an `assert` before each `return`, then decompose (§3.1)."),
    ...
    "invariant_establish":  ("3.2", "Assert the clause immediately BEFORE the loop."),
    "invariant_preserve":   ("3.2", "Assert the clause at the END of the loop body."),
