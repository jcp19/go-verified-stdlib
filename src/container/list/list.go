...
//@ requires -1 <= j && j < len(es)
//@ requires at == (j == -1 ? &l.root : es[j])
//@ ensures  l.Mem(moveSeq(es, i, j), moveSeqV(vs, i, j))
//@ decreases
...
//@ requires el != l && el != nil ==> el.Mem(ees, evs) && len(ees) == len(evs) && 0 <= i && i < len(ees) && ees[i] == e
//@ requires el == nil ==> acc(e) && e.list == nil
//@ ensures  el == l ==> l.Mem(es[:i] ++ es[i+1:], vs[:i] ++ vs[i+1:])
//@ ensures  el == l ==> acc(e) && e.list == nil && e.next == nil && e.prev == nil && e.Value === vs[i] && ret === vs[i]
//@ ensures  el != l ==> l.Mem(es, vs)
//@ ensures  el != l && el != nil ==> el.Mem(ees, evs) && ret === evs[i]
//@ ensures  el == nil ==> acc(e) && e.list == nil && e.next == old(e.next) && e.prev == old(e.prev) && e.Value === old(e.Value) && ret === old(e.Value)
//@ decreases
func (l *List) Remove(e *Element /*@ , ghost el *List, ghost es seq[*Element], ghost vs seq[any], ghost ees seq[*Element], ghost evs seq[any], ghost i int @*/ ) (ret any) {
	//@ unfold l.Mem(es, vs)
	//@ ghost if el != nil && el != l { unfold el.Mem(ees, evs) }
	inList := e.list == l
	//@ fold l.Mem(es, vs)
	if inList {
	...
	v := e.Value
	//@ ghost if el != nil && el != l { fold el.Mem(ees, evs) }
	return v
}

// PushFront inserts a new element e with value v at the front of list l and returns e.
//@ requires l.Mem(es, vs)
//@ ensures  l.Mem(seq[*Element]{ret} ++ es, seq[any]{v} ++ vs)
//@ ensures  ret != nil
//@ decreases
func (l *List) PushFront(v any /*@ , ghost es seq[*Element], ghost vs seq[any] @*/ ) (ret *Element) {
	l.lazyInit( /*@ es, vs @*/ )
...
//@ requires l.Mem(es, vs)
//@ ensures  l.Mem(es ++ seq[*Element]{ret}, vs ++ seq[any]{v})
//@ ensures  ret != nil
//@ decreases
func (l *List) PushBack(v any /*@ , ghost es seq[*Element], ghost vs seq[any] @*/ ) (ret *Element) {
	l.lazyInit( /*@ es, vs @*/ )
	//@ unfold l.Mem(es, vs)
	at := l.root.prev
	//@ fold l.Mem(es, vs)
...
//@ requires ml != l && ml != nil ==> ml.Mem(mes, mvs) && 0 <= m && m < len(mes) && mes[m] == mark
//@ requires ml == nil ==> acc(mark) && mark.list == nil
//@ ensures  ml == l ==> l.Mem(es[:m] ++ seq[*Element]{ret} ++ es[m:], vs[:m] ++ seq[any]{v} ++ vs[m:]) && ret != nil
//@ ensures  ml != l ==> l.Mem(es, vs) && ret == nil
//@ ensures  ml != l && ml != nil ==> ml.Mem(mes, mvs)
//@ ensures  ml == nil ==> acc(mark) && mark.list == nil && mark.next == old(mark.next) && mark.prev == old(mark.prev) && mark.Value === old(mark.Value)
//@ decreases
func (l *List) InsertBefore(v any, mark *Element /*@ , ghost ml *List, ghost es seq[*Element], ghost vs seq[any], ghost mes seq[*Element], ghost mvs seq[any], ghost m int @*/ ) (ret *Element) {
	//@ unfold l.Mem(es, vs)
	//@ ghost if ml != nil && ml != l { unfold ml.Mem(mes, mvs) }
	if mark.list != l {
		//@ fold l.Mem(es, vs)
		//@ ghost if ml != nil && ml != l { fold ml.Mem(mes, mvs) }
		return nil
	}
	at := mark.prev
	//@ fold l.Mem(es, vs)
...
//@ requires ml != l && ml != nil ==> ml.Mem(mes, mvs) && 0 <= m && m < len(mes) && mes[m] == mark
//@ requires ml == nil ==> acc(mark) && mark.list == nil
//@ ensures  ml == l ==> l.Mem(es[:m+1] ++ seq[*Element]{ret} ++ es[m+1:], vs[:m+1] ++ seq[any]{v} ++ vs[m+1:]) && ret != nil
//@ ensures  ml != l ==> l.Mem(es, vs) && ret == nil
//@ ensures  ml != l && ml != nil ==> ml.Mem(mes, mvs)
//@ ensures  ml == nil ==> acc(mark) && mark.list == nil && mark.next == old(mark.next) && mark.prev == old(mark.prev) && mark.Value === old(mark.Value)
//@ decreases
func (l *List) InsertAfter(v any, mark *Element /*@ , ghost ml *List, ghost es seq[*Element], ghost vs seq[any], ghost mes seq[*Element], ghost mvs seq[any], ghost m int @*/ ) (ret *Element) {
	//@ unfold l.Mem(es, vs)
	//@ ghost if ml != nil && ml != l { unfold ml.Mem(mes, mvs) }
	if mark.list != l {
		//@ fold l.Mem(es, vs)
...
//@ requires len(es) == len(vs)
//@ requires el == l ==> 0 <= i && i < len(es) && es[i] == e
//@ requires el != l && el != nil ==> el.Mem(ees, evs) && 0 <= i && i < len(ees) && ees[i] == e
//@ requires el == nil ==> acc(e) && e.list == nil
//@ ensures  el == l ==> l.Mem(moveSeq(es, i, -1), moveSeqV(vs, i, -1))
//@ ensures  el != l ==> l.Mem(es, vs)
//@ ensures  el != l && el != nil ==> el.Mem(ees, evs)
//@ ensures  el == nil ==> acc(e) && e.list == nil && e.next == old(e.next) && e.prev == old(e.prev) && e.Value === old(e.Value)
//@ decreases
func (l *List) MoveToFront(e *Element /*@ , ghost el *List, ghost es seq[*Element], ghost vs seq[any], ghost ees seq[*Element], ghost evs seq[any], ghost i int @*/ ) {
	//@ unfold l.Mem(es, vs)
	//@ assert forall i1, i2 int :: {es[i1], es[i2]} 0 <= i1 && i1 < i2 && i2 < len(es) ==> es[i1] != es[i2]
	//@ ghost if el != nil && el != l { unfold el.Mem(ees, evs) }
...
//@ requires el != l && el != nil ==> el.Mem(ees, evs) && 0 <= i && i < len(ees) && ees[i] == e
//@ requires el == nil ==> acc(e) && e.list == nil
//@ ensures  el == l ==> l.Mem(moveSeq(es, i, len(es)-1), moveSeqV(vs, i, len(vs)-1))
//@ ensures  el != l ==> l.Mem(es, vs)
//@ ensures  el != l && el != nil ==> el.Mem(ees, evs)
//@ ensures  el == nil ==> acc(e) && e.list == nil && e.next == old(e.next) && e.prev == old(e.prev) && e.Value === old(e.Value)
//@ decreases
func (l *List) MoveToBack(e *Element /*@ , ghost el *List, ghost es seq[*Element], ghost vs seq[any], ghost ees seq[*Element], ghost evs seq[any], ghost i int @*/ ) {
	//@ unfold l.Mem(es, vs)
	//@ assert forall i1, i2 int :: {es[i1], es[i2]} 0 <= i1 && i1 < i2 && i2 < len(es) ==> es[i1] != es[i2]
	//@ ghost if el != nil && el != l { unfold el.Mem(ees, evs) }
...
//@ requires ml != l && ml != nil ==> ml.Mem(mes, mvs) && 0 <= m && m < len(mes) && mes[m] == mark
//@ requires ml == nil ==> acc(mark) && mark.list == nil
//@ ensures  ml == l && i != m ==> l.Mem(moveSeq(es, i, m-1), moveSeqV(vs, i, m-1))
//@ ensures  ml == l && i == m ==> l.Mem(es, vs)
//@ ensures  ml != l ==> l.Mem(es, vs)
//@ ensures  ml != l && ml != nil ==> ml.Mem(mes, mvs)
//@ ensures  ml == nil ==> acc(mark) && mark.list == nil && mark.next == old(mark.next) && mark.prev == old(mark.prev) && mark.Value === old(mark.Value)
//@ decreases
func (l *List) MoveBefore(e, mark *Element /*@ , ghost ml *List, ghost es seq[*Element], ghost vs seq[any], ghost mes seq[*Element], ghost mvs seq[any], ghost i int, ghost m int @*/ ) {
	//@ unfold l.Mem(es, vs)
	//@ assert forall i1, i2 int :: {es[i1], es[i2]} 0 <= i1 && i1 < i2 && i2 < len(es) ==> es[i1] != es[i2]
	//@ ghost if ml != nil && ml != l { unfold ml.Mem(mes, mvs) }
...
//@ requires ml != l && ml != nil ==> ml.Mem(mes, mvs) && 0 <= m && m < len(mes) && mes[m] == mark
//@ requires ml == nil ==> acc(mark) && mark.list == nil
//@ ensures  ml == l && i != m ==> l.Mem(moveSeq(es, i, m), moveSeqV(vs, i, m))
//@ ensures  ml == l && i == m ==> l.Mem(es, vs)
//@ ensures  ml != l ==> l.Mem(es, vs)
//@ ensures  ml != l && ml != nil ==> ml.Mem(mes, mvs)
//@ ensures  ml == nil ==> acc(mark) && mark.list == nil && mark.next == old(mark.next) && mark.prev == old(mark.prev) && mark.Value === old(mark.Value)
//@ decreases
func (l *List) MoveAfter(e, mark *Element /*@ , ghost ml *List, ghost es seq[*Element], ghost vs seq[any], ghost mes seq[*Element], ghost mvs seq[any], ghost i int, ghost m int @*/ ) {
	//@ unfold l.Mem(es, vs)
	//@ assert forall i1, i2 int :: {es[i1], es[i2]} 0 <= i1 && i1 < i2 && i2 < len(es) ==> es[i1] != es[i2]
	//@ ghost if ml != nil && ml != l { unfold ml.Mem(mes, mvs) }
	stay := e.list != l || e == mark || mark.list != l
